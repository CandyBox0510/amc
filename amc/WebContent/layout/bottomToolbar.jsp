...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
       <footer class="footer-wrapper">
            <section class="container">
                ...
                <div class="col-xs-4 col-md-2 footer-nav">
                    <ul class="nav-link">
                        <li><a href="/product/getGoodsList?menu=search&searchKeyword=G" class="nav-link__item jeju">굿즈</a></li>
                        <li><a href="/product/getSnackList?menu=search&searchKeyword=S" class="nav-link__item jeju">스낵바</a></li>
