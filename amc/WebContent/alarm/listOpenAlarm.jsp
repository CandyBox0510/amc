...
<body>
							...
							<div class="col-xs-6 col-sm-4 col-md-3">
								<div class="gallery-item">
									...
									<div class="alert alert-danger" role="alert">
										<strong>티켓 오픈 일자</strong>
										<br />
										<p class="${alarm.alarmNo}">${alarm.screenContent.ticketOpenDate}</p>
										<strong>남은시간</strong>
										<br />
										<p class="a${alarm.alarmNo}"></p>
	...
	function  changeCSS() {
            ...
            $(document).ready(function() {
                ...
                changeCSS()
			              test = $(".gallery-wrapper").css('height');
                alert(test);
               ...
               $(test).change(function () {
                ...
                /* $(window).resize(function() {
			             ...
			             if($(".gallery-wrapper").css('height') != test){
			                 test=$(".gallery-wrapper").css('height')
			          ...
			          //   changeCSS()
			             ...
			             */
			             ...
			             $(".gallery-wrapper").resize(function() {
