   ...
   <div class="wrapper">
  				...
  				<h2 class="page-heading">게시글 수정</h2>
  					<form id = 'addFreeForm'>
		  				<div class="addFreeBoard">
		  					...
		  					<div class='col-md-11'><input type='text' name='freeBoardTitle' id ="freeBoardTitle" class="add__input" value="${freeBoard.freeBoardTitle}"></div>
		  					<div class='field' >
		  						<div class='col-md-12' id="context"><textarea id="freeBoardContent" name="freeBoardContent">${freeBoard.freeBoardContent }</textarea></div>
		  						<div class='col-md-1' id="title">첨부파일</div>
		  						<div class='col-md-11' >
		  						<span class="notice">이미지 파일(jpg, jpeg, png, gif)만 업로드 가능합니다</span>
		  						<input type="file" id="imageFile" name="imageFile" class="add__input" value="${freeBoard.freeBoardImage }" ></div>
		  					</div>
		  					</div>
    ...
    <!-- open/close -->
        ...
        function fncAddFreeBoard() {
        	...
        	$("form").attr("method", "POST").attr("action", "/community/updateFreeBoard").attr('enctype','multipart/form-data').submit();
		}
