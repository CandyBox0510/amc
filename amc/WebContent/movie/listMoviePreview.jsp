			...
			<div class="col-sm-12">
				...
				<div class="col-md-2 text-right">
					<form class="form-inline" name="detailForm">
						...
						<input type="text" class="form-control" id="searchKeyword" name="searchKeyword" placeholder="검색어" size="15" value="${! empty search.searchKeyword ? search.searchKeyword : '' }">
					</form>
				</div>

				<i class='fa fa-search' id="searchIcon" style="color: grey"></i> &nbsp; <i class='fa fa-microphone' id="voidSearchIcon" style="color: grey"></i>
...
P {
	...
	margin-bottom: 0px;
									...
									<p>
										<strong>감독 :${preview.movie.directors} </strong>
									</p>
									<p>
										<strong>오픈날짜 :${preview.ticketOpenDate} </strong>
									</p>
									<p>
										<strong>상영날짜 :${preview.screenOpenTime} </strong>
									</p>
									<p>
										<strong>가격 :${preview.ticketPrice} </strong>
									</p>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-heart-o' id="${preview.movie.movieNo}" style="color: #FF5733; text-align: center; margin: 0 auto;"> <input type='hidden' id='scMovieNo' value="${preview.movie.movieNo}"> <input type='hidden' id='userId' value="${user.userId}">
											</i>
										</c:if>

										<c:if test="${!empty name}">
									    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-heart' id="${preview.movie.movieNo}" style="color: #FF5733; text-align: center; margin: 0 auto;"> <input type='hidden' id='scMovieNo' value="${preview.movie.movieNo}"> <input type='hidden' id='userId' value="${user.userId}">
											</i>
										</c:if>
									</span>
	...
	<div class="ui mini modal">
		<!-- <div class="center"> -->
		<div style="border: 1px dashed #BDBDBD; background-color: #FBFCFC; margin-left: auto; margin-right: auto; padding: 5px; text-align: center; line-height: 30px; vertical-align: middle;">
			<div class="header">영화 음성 검색 중....</div>
			<div class="content">
				<p>
				<form id="webspeech" method="POST">
					<div class="image content">
						<img class="image"> <img src="../images/movie/speechListening2.gif">
						<div class="description">
							...
							<div class="actions">
								...
								<div class="ui red deny button">나가기</div>
							</div>
